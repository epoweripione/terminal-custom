...
CLASH_CONFIG=${6:-"${MY_SHELL_SCRIPTS:-$HOME/terminal-custom}/cross/clash_client_config.yml"}
...
SUB_LIST_FILE=${7:-"${MY_SHELL_SCRIPTS:-$HOME/terminal-custom}/cross/clash_client_subscription.list"}
